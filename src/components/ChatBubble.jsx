...
const ChatBubble = ({ children, animate }) => {
  return (
    <m.div
      ...
      initial="initial"
      animate={animate}
      className="absolute sm:min-w-[400px] max-w-[600px] font-mochiy -top-4 sm:top-10 left-0 sm:left-[90%] p-4 sm:p-6 bg-white rounded-t-lg rounded-bl-lg sm:rounded-bl-none rounded-br-lg">
